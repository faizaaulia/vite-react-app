...
const AppLayout = ({children}) =>{
    ...
    return (
        <div className="bg-slate-800 w-full min-h-screen text-white">
            {/* Navigation */}
            <div className="flex flex-col md:flex-row  py-4 px-4 md:px-8 items-center justify-between w-full">
                <nav className="flex flex-grow w-full items-center justify-between py-4 md:py-0">
                ...
                <div className={`${open ? 'flex' : 'hidden md:flex'} flex-col md:flex-row w-full justify-end`}>
